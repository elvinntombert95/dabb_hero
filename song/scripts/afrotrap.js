...
var red_timing = [0,1064,2050,3060,4045,5010,5980,6890,7970,8920,9910,10855];
var blue_timing = [1349,3315,5270,7240,9160,11159];
var yellow_timing = [1845,3790,5770,7481,9685];
var green_timing = [];
var dab_timing = [11777];
var game = {};
game.score = 0;
var count = 0;
var $canvas = $('.canvas');
